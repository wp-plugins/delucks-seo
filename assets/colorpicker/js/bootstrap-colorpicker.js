    ...
    (function($) {
        ...
        Colorpicker.prototype = {
            ...
            updatePicker: function(val) {
                ...
                this.picker.find('.colorpicker-saturation').css('color', this.color.toHex(this.color.value.h, 1, 1, 1));
                this.picker.find('.colorpicker-alpha').css('color', this.color.toHex());
                this.picker.find('.colorpicker-color, .colorpicker-color div').css('color', this.color.toString(this.format));
                return val;
            },
